...
namespace BreastCancer
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                swagger.SwaggerDoc("v1", new OpenApiInfo { Title = "Breast Cancer API", Version = "v1" });
            ...
            builder.Services.AddAuthentication(options =>
            {
                ...
                var SignKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(builder.Configuration["JWT:Key"]));
